...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Latitude\PycharmProjects\pythonProject5\Prejeto_automação'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Latitude\PycharmProjects\pythonProject5\Prejeto_automação\Scripts\deactivate.nu'
